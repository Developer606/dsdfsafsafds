// Migration script to add is_blocked column to user_conversations table
...
async function main() {
  try {
    ...
    console.log('Starting migration to add is_blocked column to user_conversations table...');
    ...
    if (hasIsBlocked) {
      ...
      console.log('Successfully added is_blocked column to user_conversations table');
    }
