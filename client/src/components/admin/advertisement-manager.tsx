                  ...
                  {formValues.mediaType === 'image' ? (
                    ...
                    <div>
                      <div className="mb-4">
                        ...
                        />
                        <p className="text-xs text-gray-500 mt-1">
                          Enter a YouTube URL (e.g., https://youtu.be/VIDEO_ID) or upload a video below
                        </p>
                        {formValues.videoUrl && formValues.videoUrl.includes('youtu') && (
                          <div className="mt-2 p-2 bg-gray-50 dark:bg-gray-800 rounded-md">
                            <div className="text-xs text-green-600 dark:text-green-400 flex items-center">
                              <span className="mr-1">✓</span> YouTube URL detected
                            </div>
                            <p className="text-xs text-gray-500 mt-1">
                              The video will be embedded from YouTube
                            </p>
                          </div>
                        )}
                      </div>
