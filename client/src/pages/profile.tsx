            ...
            <div className="flex items-center">
              <div className="mr-6">
                <div className="relative">
                  ...
                  <Badge
                    className={`absolute -bottom-2 right-0 ${getSubscriptionColor()} px-2 py-0.5 text-xs`}
                  >
              ...
              <div className="flex-1">
                ...
                <div className="flex flex-wrap gap-2 mt-3">
                  {user.email && (
                    <Badge
                      variant="outline"
                      className="bg-gray-100 dark:bg-gray-800 text-gray-800 dark:text-gray-200 px-2 py-1 flex items-center text-xs"
                    >
      ...
      <div className="container mx-auto px-4 py-6">
        <Tabs defaultValue="about" className="w-full">
          <TabsList className="w-full max-w-md mx-auto mb-6 flex border border-gray-200 dark:border-gray-800 rounded-lg overflow-hidden">
            <TabsTrigger
              value="about"
              className="flex-1 py-2 data-[state=active]:bg-blue-600 data-[state=active]:text-white"
            >
              About
            </TabsTrigger>
            <TabsTrigger
                ...
                {isLoading ? (
                  ...
                  <div>
                    ...
                    <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
                      {user.bio ||
                        "No bio provided yet. Click the Edit Profile button to add some information about yourself."}
                    </p>
                  </div>
                ) : (
                  <p className="text-gray-500 dark:text-gray-400">
                    ...
                    <div className="space-y-3 mt-6">
                      <div className="flex items-center">
                        ...
                        <span className="text-gray-700 dark:text-gray-300">
                          Access to all basic characters
                        </span>
                      </div>
